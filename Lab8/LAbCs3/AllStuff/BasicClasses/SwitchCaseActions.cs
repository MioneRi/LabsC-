...
namespace LAbCs3
{
    public class SwitchCaseActions
    {
        ...
        public static void AddStudent()
        {
            ...
            addedStudent.Move += delegate (string ms) { WriteLine(ms); };

            Set ourSet = addedStudent.SetInfo;
            ourSet?.Invoke();            
        ...
        public static void FindEmployeeByID()
        {
            ...
            foreach (Employee ourEmployee in ListOfEmployees.Journal)
            {
                ...
                {
                    ourShowInfo = ourEmployee.ShowInfo;
                    ourShowInfo?.Invoke();
                    flag = true;
                }
            }
